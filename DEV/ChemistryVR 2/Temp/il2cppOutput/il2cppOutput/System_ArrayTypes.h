...
// System.Net.IPEndPoint[]
struct IPEndPointU5BU5D_t1575178931  : public Il2CppArray
{
public:
	ALIGN_FIELD (8) IPEndPoint_t2123960758 * m_Items[1];

public:
	inline IPEndPoint_t2123960758 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline IPEndPoint_t2123960758 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, IPEndPoint_t2123960758 * value)
	{
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
	}
